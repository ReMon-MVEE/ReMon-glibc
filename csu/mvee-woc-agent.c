...
unsigned char mvee_atomic_preop_internal(volatile void* word_ptr)
{
    ...
    {
		long mvee_thread_local_queue_id = syscall(MVEE_GET_SHARED_BUFFER, &mvee_counters, MVEE_LIBC_ATOMIC_BUFFER, &mvee_thread_local_queue_size, &mvee_thread_local_pos, NULL, &mvee_thread_local_queue);
